...
**Status:** done 2026-08-30 — `poly.rs`; `ExactNumPoly`; companion closed form through degree `POLY_COMPANION_CLOSED_DEG=2`.
...
**Status:** done 2026-08-30 — `roots.rs`; `ROOT_MAX_ITER=256`; `ROOT_DEFAULT_TOL=-256`.
...
**Status:** done 2026-08-30 — `modular.rs`; `POLLARD_RHO_ITER_MAX=1048576`. Brent ρ; Miller–Rabin uses the caller’s witnesses.
