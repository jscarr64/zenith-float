...
Not a second product. First open implementation slice after remaining partials is **§19.3 Benchmark suite**. Partial rows (`expr!` composite golds) stay 🟡 until their golds land.
